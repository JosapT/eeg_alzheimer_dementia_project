...
```
Note: If notebooks are crashing and the script is not working, there is most likely two versions of libomp conflicted on brew and conda in your system/environment
